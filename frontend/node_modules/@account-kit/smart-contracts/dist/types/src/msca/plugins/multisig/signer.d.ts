...
export declare const multisigSignMethods: <TTransport extends Transport, TSigner extends SmartAccountSigner<any>>({ client, accountAddress, signer, threshold, pluginAddress, }: MultisigSignMethodsParams<TTransport, TSigner>) => {
